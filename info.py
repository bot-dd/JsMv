...
USERNAME = environ.get('USERNAME', "https://t.me/RahatMx") # ADMIN USERNAME
...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ragwresf:sacgiuhgdhucshug@rahat3.t04iu.mongodb.net/?retryWrites=true&w=majority&appName=rahat3")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
LANGUAGES = ["hindi", "bangla", "english", "telugu", "tamil", "kannada", "malayalam", "bengali", "marathi", "gujarati", "punjabi", "marathi"]
